const r=[{id:"tmpl_room_booking_req",code:"MEETING_BOOKING_REQUEST",category:"room_booking",name:"Thông báo Yêu cầu Đặt phòng Họp (Gửi Ban Quản Trị)",description:"Tự động gửi đến Quản trị viên khi có hội viên / cán bộ ban đăng ký sử dụng phòng họp Online hoặc Offline.",targetRole:"admin",channels:["email","in_app","push"],subject:"[YÊU CẦU DUYỆT PHÒNG HỌP] {{meetingTitle}} - {{requesterName}}",inAppTitle:"Yêu cầu đặt phòng họp mới từ {{requesterName}}",inAppBody:"{{requesterName}} vừa gửi yêu cầu book phòng '{{roomName}}' cho cuộc họp '{{meetingTitle}}' vào lúc {{startTime}} ngày {{date}}.",variables:[{key:"requesterName",label:"Tên người đặt",example:"Lê Hoàng Long"},{key:"requesterEmail",label:"Email người đặt",example:"long.le@ceo1983.com"},{key:"requesterPhone",label:"Số điện thoại",example:"0983 000 001"},{key:"meetingTitle",label:"Tiêu đề cuộc họp",example:"Họp Ban Xúc Tiến Thương Mại Quý 3"},{key:"roomName",label:"Tên phòng họp",example:"Phòng Họp VIP Sapphire (Tầng 5)"},{key:"meetingMode",label:"Hình thức",example:"Offline kết hợp Zoom trực tuyến"},{key:"date",label:"Ngày họp",example:"15/10/2026"},{key:"startTime",label:"Giờ bắt đầu",example:"14:30"},{key:"endTime",label:"Giờ kết thúc",example:"16:30"},{key:"attendeesCount",label:"Số lượng tham dự",example:"15 đại biểu"},{key:"approvalUrl",label:"Link duyệt nhanh",example:"https://vione.app/meetings?tab=bookings&id=BK-1983"}],isLocked:!0,updatedAt:"2026-09-12",htmlBody:`
...
`},{id:"tmpl_room_booking_approved",code:"MEETING_BOOKING_CONFIRMED",category:"room_booking",name:"Xác nhận Phê Duyệt Phòng Họp (Gửi Người Đăng Ký & Thành Viên)",description:"Gửi thông báo và email xác nhận khi Quản trị viên đã phê duyệt yêu cầu đặt phòng (kèm link Online hoặc phòng Offline).",targetRole:"requester",channels:["email","in_app","push"],subject:"[XÁC NHẬN ĐÃ DUYỆT] Phòng Họp: {{meetingTitle}} - {{roomName}}",inAppTitle:"Phòng họp '{{meetingTitle}}' đã được Ban Quản Trị phê duyệt!",inAppBody:"Chúc mừng bạn! Yêu cầu sử dụng phòng '{{roomName}}' ngày {{date}} ({{startTime}} - {{endTime}}) đã được duyệt. Xem link họp và chỉ dẫn sử dụng tại đây.",variables:[{key:"requesterName",label:"Tên người đặt",example:"Lê Hoàng Long"},{key:"meetingTitle",label:"Tiêu đề cuộc họp",example:"Họp Ban Xúc Tiến Thương Mại Quý 3"},{key:"roomName",label:"Tên phòng",example:"Phòng Họp VIP Sapphire (Tầng 5)"},{key:"locationAddress",label:"Địa chỉ phòng offline",example:"Văn phòng Hiệp hội CEO 1983, Tầng 5 Tòa nhà V-Tower, Hà Nội"},{key:"onlineMeetingUrl",label:"Link họp Online (Zoom/Meet)",example:"https://zoom.us/j/88819839999?pwd=CEO"},{key:"passcode",label:"Mật khẩu phòng",example:"198388"},{key:"date",label:"Ngày họp",example:"15/10/2026"},{key:"startTime",label:"Bắt đầu",example:"14:30"},{key:"endTime",label:"Kết thúc",example:"16:30"},{key:"adminNotes",label:"Ghi chú từ Ban Quản Trị",example:"Đã bật sẵn màn hình LED và mic Polycom cho đoàn."}],isLocked:!0,updatedAt:"2026-09-12",htmlBody:`
<div style="font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, sans-serif; max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
...
`},{id:"tmpl_room_booking_declined",code:"MEETING_BOOKING_REJECTED",category:"room_booking",name:"Thông Báo Từ Chối Đặt Phòng (Gửi Người Đăng Ký)",description:"Gửi thông báo giải thích lý do khi Quản trị viên không thể duyệt phòng họp và hướng dẫn chọn giờ thay thế.",targetRole:"requester",channels:["email","in_app"],subject:"[THÔNG BÁO] Yêu cầu phòng họp '{{meetingTitle}}' chưa được phê duyệt",inAppTitle:"Yêu cầu phòng họp '{{meetingTitle}}' bị từ chối",inAppBody:"Rất tiếc, phòng họp '{{roomName}}' vào {{startTime}} ngày {{date}} chưa thể duyệt vì: {{rejectionReason}}.",variables:[{key:"requesterName",label:"Tên người đặt",example:"Lê Hoàng Long"},{key:"meetingTitle",label:"Tiêu đề cuộc họp",example:"Họp Ban Xúc Tiến Thương Mại Quý 3"},{key:"roomName",label:"Tên phòng",example:"Phòng Họp VIP Sapphire"},{key:"rejectionReason",label:"Lý do từ chối",example:"Trùng lịch họp đột xuất của Hội Đồng Cố Vấn Ban Chấp Hành."},{key:"suggestedAlternative",label:"Gợi ý thay thế",example:"Phòng Hội Thảo Tầng 3 còn trống lúc 16:30 cùng ngày."},{key:"rebookUrl",label:"Link đặt lại",example:"https://vione.app/meetings?tab=book"}],isLocked:!0,updatedAt:"2026-09-12",htmlBody:`
...
`},{id:"tmpl_payment_invoice_pending",code:"PAYMENT_INVOICE_PENDING",category:"payment",name:"Lệnh Thanh Toán & Mã QR Chuyển Khoản VietQR",description:"Gửi thông báo thanh toán (phí hội viên, vé sự kiện, gói tài trợ) kèm mã QR chuẩn VietQR tự động điền số tiền và nội dung.",targetRole:"payer",channels:["email","in_app","push"],subject:"[LỆNH THANH TOÁN] {{serviceName}} - Số tiền: {{amountFormatted}}",inAppTitle:"Lệnh thanh toán: {{serviceName}}",inAppBody:"Quý hội viên có lệnh thanh toán {{amountFormatted}} cho '{{serviceName}}'. Quét VietQR hoặc chuyển khoản trước {{deadline}}.",variables:[{key:"payerName",label:"Tên người nộp",example:"Vũ Thu Trang"},{key:"serviceName",label:"Dịch vụ / Hạng mục",example:"Vé VIP Gala Dinner Doanh Nhân 1983"},{key:"amountFormatted",label:"Số tiền",example:"2.500.000 VNĐ"},{key:"invoiceCode",label:"Mã hoá đơn",example:"INV-2026-8891"},{key:"bankName",label:"Ngân hàng thụ hưởng",example:"Ngân hàng TMCP Quân Đội (MB Bank)"},{key:"accountNumber",label:"Số tài khoản",example:"198388889999"},{key:"accountHolder",label:"Chủ tài khoản",example:"CLB DOANH NHAN CEO 1983"},{key:"transferContent",label:"Nội dung chuyển khoản",example:"INV8891 VU THU TRANG"},{key:"qrCodeUrl",label:"Link ảnh VietQR",example:"https://img.vietqr.io/image/MB-198388889999-compact2.png?amount=2500000&addInfo=INV8891%20VU%20THU%20TRANG"},{key:"deadline",label:"Hạn chót thanh toán",example:"18:00 ngày 14/10/2026"}],isLocked:!0,updatedAt:"2026-09-12",htmlBody:`
<div style="font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, sans-serif; max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
...
`},{id:"tmpl_payment_receipt_success",code:"PAYMENT_RECEIPT_SUCCESS",category:"payment",name:"Biên Nhận Xác Nhận Thanh Toán Thành Công",description:"Gửi biên nhận điện tử xác nhận đã thu tiền thành công kèm mã giao dịch và quyền lợi hội viên.",targetRole:"payer",channels:["email","in_app"],subject:"[BIÊN NHẬN ĐIỆN TỬ] Xác nhận thanh toán thành công - {{serviceName}}",inAppTitle:"Thanh toán thành công: {{serviceName}}",inAppBody:"Hệ thống đã nhận {{amountFormatted}} cho giao dịch {{transactionCode}}. Cảm ơn Quý hội viên!",variables:[{key:"payerName",label:"Tên người nộp",example:"Vũ Thu Trang"},{key:"serviceName",label:"Dịch vụ",example:"Vé VIP Gala Dinner Doanh Nhân 1983"},{key:"amountFormatted",label:"Số tiền đã nộp",example:"2.500.000 VNĐ"},{key:"transactionCode",label:"Mã giao dịch",example:"TXN-2026-99120"},{key:"paidAt",label:"Thời gian thanh toán",example:"10:15 ngày 12/09/2026"},{key:"receiptDownloadUrl",label:"Link tải biên lai PDF",example:"https://vione.app/finance/receipt?id=TXN-99120"}],isLocked:!0,updatedAt:"2026-09-12",htmlBody:`
<div style="font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, sans-serif; max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden;">
...
`},{id:"tmpl_event_announcement",code:"EVENT_ANNOUNCEMENT",category:"event",name:"Thông Báo Khởi Động Sự Kiện Mới Trong Hiệp Hội",description:"Gửi thư mời và công bố sự kiện mới tới toàn thể hội viên và khách mời tiềm năng.",targetRole:"members",channels:["email","in_app","push"],subject:"[THƯ MỜI SỰ KIỆN] {{eventName}} - {{eventDate}}",inAppTitle:"Sự kiện mới: {{eventName}}",inAppBody:"Hiệp hội trân trọng kính mời Quý Doanh nhân tham dự '{{eventName}}' vào ngày {{eventDate}} tại {{eventLocation}}.",variables:[{key:"memberName",label:"Tên hội viên",example:"Đỗ Thị Mai"},{key:"eventName",label:"Tên sự kiện",example:"Diễn Đàn Chuyển Đổi Số & Kết Nối Giao Thương 2026"},{key:"eventDate",label:"Ngày diễn ra",example:"20/11/2026"},{key:"eventLocation",label:"Địa điểm",example:"Trung tâm Hội nghị Quốc Gia, Hà Nội"},{key:"keySpeakers",label:"Diễn giả tiêu biểu",example:"Chủ tịch Hiệp hội, TS. Kinh tế học Đỗ Văn Nam"},{key:"registrationUrl",label:"Link đăng ký",example:"https://vione.app/events/evt-2026"}],isLocked:!0,updatedAt:"2026-09-12",htmlBody:`
<div style="font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, sans-serif; max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden;">
...
`},{id:"tmpl_event_ticket_confirmation",code:"EVENT_TICKET_CONFIRMATION",category:"event",name:"Vé Mời Điện Tử & Mã QR Check-in (Kèm Số Bàn Tiệc Gala)",description:"Tự động gửi vé mời có mã QR, vị trí ghế ngồi hoặc số bàn tiệc Gala ngay sau khi người dùng điền Form đăng ký.",targetRole:"attendees",channels:["email","in_app","push"],subject:"[VÉ MỜI ĐIỆN TỬ] {{eventName}} - Mã vé: {{ticketCode}}",inAppTitle:"Vé mời sự kiện '{{eventName}}' của bạn đã sẵn sàng!",inAppBody:"Mã vé {{ticketCode}} | Vị trí: {{seatOrTable}} | Quý khách vui lòng xuất trình mã QR tại cửa Check-in.",variables:[{key:"attendeeName",label:"Tên đại biểu",example:"Phạm Quang Huy"},{key:"eventName",label:"Tên sự kiện",example:"Gala Dinner & Business Networking 2026"},{key:"ticketCode",label:"Mã vé",example:"TKT-8839-GL"},{key:"seatOrTable",label:"Vị trí bàn tiệc / ghế",example:"Bàn Tiệc VIP 02 (Bàn Tròn 10 Chỗ)"},{key:"ticketType",label:"Hạng vé",example:"Vé Đại Biểu VIP"},{key:"eventTime",label:"Thời gian",example:"17:30 - 21:30 ngày 25/11/2026"},{key:"eventAddress",label:"Địa chỉ",example:"Khách sạn Grand Plaza, 117 Trần Duy Hưng, Hà Nội"},{key:"qrCodeDataUrl",label:"Mã QR Check-in",example:"https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=VIONE-TKT-8839-GL"}],isLocked:!0,updatedAt:"2026-09-12",htmlBody:`
<div style="font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, sans-serif; max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
...
`},{id:"tmpl_cross_app_message",code:"CROSS_APP_COMMUNITY_MESSAGE",category:"cross_app",name:"Thông Điệp Đồng Bộ 2 Chiều Giữa 2 App Vione Trong Cùng Hiệp Hội",description:"Đảm bảo luồng dữ liệu 2 chiều (luồng đi có luồng về) giữa Web CRM Admin và 2 ứng dụng Vione Mobile của cùng một Hiệp hội.",targetRole:"members",channels:["in_app","push"],subject:"[VIONE CONNECT] Tin nhắn mới từ {{senderName}} ({{associationName}})",inAppTitle:"Tin nhắn từ {{senderName}} - {{associationName}}",inAppBody:"{{messageSnippet}}",variables:[{key:"senderName",label:"Người gửi",example:"Ban Thư Ký Hiệp Hội"},{key:"receiverName",label:"Người nhận",example:"Hoàng Minh Tuấn"},{key:"associationName",label:"Tên Hiệp hội",example:"CLB Doanh Nhân CEO 1983"},{key:"messageSnippet",label:"Nội dung tóm tắt",example:"Kính gửi anh Tuấn, Ban Xúc Tiến Thương Mại đã xác nhận hồ sơ kết nối B2B với tập đoàn An Phát."},{key:"threadUrl",label:"Link mở hội thoại",example:"vione://chat/thread/TH-1983-09"}],isLocked:!0,updatedAt:"2026-09-12",htmlBody:`
...
`}];function t(e,n){let i=e;for(const[o,a]of Object.entries(n)){const p=new RegExp(`{{\\s*${o}\\s*}}`,"g");i=i.replace(p,a||"")}return i}function d(e,n){return{subject:t(e.subject,n),inAppTitle:t(e.inAppTitle,n),inAppBody:t(e.inAppBody,n),htmlBody:t(e.htmlBody,n)}}export{r as N,d as r};
